    ...
    return (
        <div className="site-page-content">
            ...
            <div className="text-block">
                <h2>after-hours.dev</h2>
                <br />
                <p>
                    after-hours.dev is my portfolio website, and also the
                    website you are on right now. This project was an absolute
                    joy to make and challenged me both technically and
                    creatively. I wanted to create an immersive, atmospheric
                    experience that goes beyond a typical portfolio — something
                    that feels handcrafted and alive. If you are reading this,
                ...
                <ul>
                    ...
                    <li>
                        ...
                        >
                            <p>
                                <b>[OS Site]</b> - after-hours.dev/os
                            </p>
                        </a>
                    </li>
                    <li>
                        <a
                            rel="noreferrer"
                            target="_blank"
                            href="https://github.com/dapaaa11/portfolio-3d"
                        >
                            <p>
